...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        let v3_y = (v1[2] * v2[0]) - (v1[0] * v2[2]);
        let v3_z = (v1[0] * v2[1]) - (v1[1] * v2[0]);

        let v3 = new Vector3([v3_x, v3_y, v3_z]); // Modify this line to calculate cross product between other1 and other2.
    ...
    magnitude() {
        ...
        let m = Math.hypot(v1[0], v1[1], v1[2]); // Modify this line to calculate this vector's magnitude.
